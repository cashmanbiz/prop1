...
<?php if ( have_properties() ): ?>
  ...
  <!-- <div class="<?php wpp_css('property_overview::right_column', 'wpp_overview_right_column' ); ?>">
        ...
        <ul class="<?php wpp_css('property_overview::data', 'wpp_overview_data_detail' ); ?>">
      ...
      <div class="<?php wpp_css('property_overview::right_column', 'wpp_overview_feps_column' ); ?>">
        ...
        <li class="<?php wpp_css('property_overview::expired_date', "expired_date {$class}" ); ?>">
          ...
          <li class="<?php wpp_css('property_overview::actions', 'actions' ); ?>">
            <ul class="clearfix">
              <li>
                <a class="<?php wpp_css('property_overview::button', 'denali-button button wpp_edit' ); ?>" href="<?php echo class_wpp_feps::get_edit_feps_permalink( $property['ID'], 'edit' ); ?>"><?php _e('Edit', 'wpp'); ?></a>
              </li>
              <li>
                <a class="<?php wpp_css('property_overview::button', 'denali-button button' ); ?>" href="<?php echo WPP_F::base_url( FEPS_VIEW_PAGE, array( 'feps' => $property['ID'], 'hash' => $property['wpp::feps::pending_hash'], 'action' => 'remove' ) ); ?>" onclick="return confirm('<?php _e('Are you sure?', 'wpp'); ?>')"><?php _e('Remove', 'wpp'); ?></a>
              </li>
            </ul>
          </li>
          <?php endif; ?>
