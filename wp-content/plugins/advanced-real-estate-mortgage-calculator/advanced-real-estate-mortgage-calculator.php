...
class Propertyprice {
    ...
    public function setPrice($property_price)
    {
        $this->price = $property_price;
    }
...
function get_price($priceobj){

	if($priceobj->getPrice()){
		return $priceobj->getPrice() ;
	} else {
		$price=get_option('aremc_price');	
		return $price;
	}
}
	...
	foreach ( $setting_vars as $setting_var ){
		...
		if ( $cur_value === false) {
			...
			elseif ($setting_var == 'aremc_txt_instructions'){
				update_option( $setting_var, 'Change any field values to re-calculate.' );
			}
...
function aremc_markup(){
	...
	$aremc_markup = '<form id="aremc" action=""><div class="mcleft"><span class="aremc_label">' . $aremc_txt_selling_price . '</span></div><div class="mcsymbol"> <span class="aremc_field">' . $aremc_txt_money_symbol . '</span></div><div class="mcvalue"> <input name="text" type="text" id="textA" onfocus="this.className=';
	$aremc_markup .= "'boxFocus'";
	$aremc_markup .= '" onkeydown="xdelay(';
	$aremc_markup .= "'a'";
	$aremc_markup .= ')" value="' . $aremc_price . '" size="12" autocomplete="off" /></span></div>';
	$aremc_markup .= '<div class="mcleft"><span class="aremc_label">'. $aremc_txt_down_payment . '</span></div><div class="mcsymbol"><span class="aremc_field">'. $aremc_txt_money_symbol .'</span></div><div class="mcvalue"><input name="text4" type="text" id="textD" onkeydown="xdelay(';
	$aremc_markup .= "'d'";
	$aremc_markup .= ')" value="' . $aremc_down . '" size="12" autocomplete="off"/></span></div><div class="mcleft"><span class="aremc_label">' . $aremc_txt_interest_rate . '</span></div><div class="mcsymbol"><span class="aremc_field">%</span></div><div class="mcvalue"> <input name="text2" type="text" id="textB" onfocus="this.className=';
	$aremc_markup .= "'boxFocus'";
	$aremc_markup .= '" onkeydown="xdelay(';
	$aremc_markup .= "'b'";
	$aremc_markup .= ')" value="' . $aremc_interest . '" size="5" autocomplete="off"/></span></div>';
/*	$arems_markup .= '<div class="mcleft"><span class="aremc_label">' . $aremc_txt_years . '</span></div><div class="mcsymbol"><span class="aremc_field">&nbsp;</span></div><div class="mcvalue"> <input name="text3" type="text" id="textC" onfocus="this.className=';
	$aremc_markup .= "'boxFocus'";
	$aremc_markup .= '" onkeydown="xdelay(';
	$aremc_markup .= "'c'";
	$aremc_markup .= ')" value="' . $aremc_years . '" size="5" autocomplete="off"/></span></div>';
*/	
	$aremc_markup .= '<div class="mcleft"><span class="aremc_label">' . $aremc_txt_years . '</span></div><div class="mcsymbol"><span class="aremc_field">&nbsp;</span></div><div class="mcvalue"> <input name="text3" type="text" id="textC" onfocus="this.className=';
	$aremc_markup .= "'boxFocus'";
	$aremc_markup .= '" onkeydown="xdelay(';
	$aremc_markup .= "'c'";
	$aremc_markup .= ')" value="' . $aremc_years . '" size="5" autocomplete="off"/></span></div>';
...
$aremc_markup .= '<div class="mcleft"><span class="aremc_label">' . $aremc_txt_monthly_payment . '</span></div><div class="mcsymbol"><span class="aremc_field">' . $aremc_txt_money_symbol . '</span> </div><div class="mcvalue"><input name="text5" type="text" id="resultbox" onkeydown="xdelay(';
	$aremc_markup .= "'x'";
	$aremc_markup .= ')" value="" size="12"/></span></div>';
	$aremc_markup .= '<div class="mcsubmit"><span class="aremc_text">' . $aremc_txt_instructions . '</span></div>'; 
	$aremc_markup .= '</form>';
	return $aremc_markup;
}
