...
function aremc_markup(){
	...
	$aremc_markup = '<form id="aremc" action=""><table><tr><td style="width: 120px;"><span class="aremc_label">' . $aremc_txt_selling_price . '</span></td><td style="width: 130px"><span class="aremc_field">' . $aremc_txt_money_symbol . ' <input name="text" type="text" id="textA" onfocus="this.className=';
	$aremc_markup .= "'boxFocus'";
	$aremc_markup .= '" onkeydown="xdelay(';
	$aremc_markup .= "'a'";
	$aremc_markup .= ')" value="' . $aremc_price . '" size="12" autocomplete="off" /></span></td></tr><tr><td><span class="aremc_label">'. $aremc_txt_down_payment . '</span></td><td ><span class="aremc_field">'. $aremc_txt_money_symbol ." ".'<input name="text4" type="text" id="textD" onkeydown="xdelay(';
	$aremc_markup .= "'d'";
	$aremc_markup .= ')" value="' . $aremc_down . '" size="12" autocomplete="off"/></span></td></tr><tr><td><span class="aremc_label">' . $aremc_txt_interest_rate . '</span></td><td><span class="aremc_field">% <input name="text2" type="text" id="textB" onfocus="this.className=';
	$aremc_markup .= "'boxFocus'";
	$aremc_markup .= '" onkeydown="xdelay(';
	$aremc_markup .= "'b'";
	$aremc_markup .= ')" value="' . $aremc_interest . '" size="5" autocomplete="off"/></span></td></tr><tr><td><span class="aremc_label">' . $aremc_txt_years . '</span></td><td><span class="aremc_field">&nbsp;&nbsp;<input name="text3" type="text" id="textC" onfocus="this.className=';
	$aremc_markup .= "'boxFocus'";
	$aremc_markup .= '" onkeydown="xdelay(';
	$aremc_markup .= "'c'";
	$aremc_markup .= ')" value="' . $aremc_years . '" size="5" autocomplete="off"/></span></td></tr><tr><td><span class="aremc_label">' . $aremc_txt_monthly_payment . '</span></td><td><span class="aremc_field">' . $aremc_txt_money_symbol . ' <input name="text5" type="text" id="resultbox" onkeydown="xdelay(';
	$aremc_markup .= "'x'";
	$aremc_markup .= ')" value="" size="12"/></span></td></tr><tr><td colspan=2><span class="aremc_text">' . $aremc_txt_instructions . '</span></td><td style="clear:both;"><!-- --></td></tr></table></form>';
	return $aremc_markup;
}
